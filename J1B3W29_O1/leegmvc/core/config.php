...
define('DB_NAME', 'plannings_tool'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'planning'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
